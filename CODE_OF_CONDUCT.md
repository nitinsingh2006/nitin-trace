...
- 🌟 **Being welcoming** — Making newcomers feel welcome and valued
- 🙏 **Showing empathy** — Understanding different perspectives and experiences
- 📚 **Being patient** — Helping others learn and grow
- 🎉 **Celebrating success** — Acknowledging contributions and achievements
- 🔍 **Being open-minded** — Accepting constructive criticism gracefully
...
- ❌ **Threats** — Threatening violence or harm to others
...
- Any other official N-Trace community space
...
- **GitHub**: Use the "Report abuse" feature
...
This Code of Conduct is adapted from the [Contributor Covenant](https://ww